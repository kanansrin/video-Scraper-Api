...
def scrape_data(request):
    if(request.GET.get('channelid')==None):
        ...
        url='https://youtube.googleapis.com/youtube/v3/activities?part=snippet%2CcontentDetails&channelId='+channelid+'&maxResults=10&key=AIzaSyCgTNdaRSwAsHCb6m_rKcUTmEuxjaC8X6U&maxResults=10&type=video'
