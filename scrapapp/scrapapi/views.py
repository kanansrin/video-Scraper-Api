...
def scrape_data(request):
    if(request.GET.get('channelid')==None):
        ...
        url='https://youtube.googleapis.com/youtube/v3/activities?part=snippet%2CcontentDetails&channelId='+channelid+'&maxResults='+result+'&key=AIzaSyCgTNdaRSwAsHCb6m_rKcUTmEuxjaC8X6U&maxResults='+result+'&type=video'
        # url='https://youtube.googleapis.com/youtube/v3/activities?part=snippet%2CcontentDetails&channelId=UC16niRr50-MSBwiO3YDb3RA&maxResults=25&key=AIzaSyCgTNdaRSwAsHCb6m_rKcUTmEuxjaC8X6U&maxResults=25&type=video'
